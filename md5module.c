...
"update (arg)\n\
\n\
Update the md5daap object with the string arg. Repeated calls are\n\
...
"copy() -> md5daap object\n\
\n\
Return a copy (``clone'') of the md5daap object.");
...
straightforward: use the new() to create an md5daap object. You can now\n\
...
Functions:\n\
\n\
new([arg]) -- return a new md5daap object, initialized with arg if provided\n\
md5([arg]) -- DEPRECATED, same as new, but for compatibility\n\
\n\
Special Objects:\n\
\n\
MD5Type -- type object for md5daap objects");

PyDoc_STRVAR(md5type_doc,
"An md5daap represents the object used to calculate the MD5 checksum of a\n\
...
copy() -- return a copy of the current md5daap object");
...
"new([arg]) -> md5daap object\n\
\n\
Return a new md5daap object. If arg is present, the method call update(arg)\n\
is made.");
